...
namespace Len.Jakpro.PID.Logging
{
    public class NLogConfigurator
    {
        ...
        public NLogConfigurator()
        {
            ...
            _logFileNamePattern = "${specialfolder:folder=CommonApplicationData}/Company/zenon/Len.Jakpro.PID.Log/${processname}_" + addInName  + ".log";
