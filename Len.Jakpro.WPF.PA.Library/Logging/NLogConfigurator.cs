...
namespace Len.Jakpro.PA.Logging
{
    public class NLogConfigurator
    {
        ...
        public NLogConfigurator()
        {
            ...
            _logFileNamePattern = "${specialfolder:folder=CommonApplicationData}/Company/zenon/Len.Jakpro.PA.Log/${processname}_" + addInName  + ".log";
