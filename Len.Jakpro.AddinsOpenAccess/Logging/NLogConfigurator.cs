...
namespace Len.Jakpro.Addins.Logging
{
    public class NLogConfigurator
    {
        ...
        public NLogConfigurator()
        {
            ...
            _logFileNamePattern = "${specialfolder:folder=CommonApplicationData}/Company/zenon/Len.Jakpro.Addins.Log/${processname}_" + addInName  + ".log";
