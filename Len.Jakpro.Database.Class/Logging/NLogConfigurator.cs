...
namespace Len.Jakpro.Logging
{
    public class NLogConfigurator
    {
        ...
        public NLogConfigurator()
        {
            ...
            _logFileNamePattern = "${specialfolder:folder=CommonApplicationData}/Company/zenon/Len.Jakpro.Database.Log/${processname}_" + addInName  + ".log";
