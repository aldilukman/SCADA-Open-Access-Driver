...
public class PlatformInfo : NamedId {
  ...
  public void setPassers(ServiceStopList serviceStops) {
    netspireSDKPINVOKE.PlatformInfo_setPassers__SWIG_0(swigCPtr, ServiceStopList.getCPtr(serviceStops));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void setPassers(ServiceList services) {
    netspireSDKPINVOKE.PlatformInfo_setPassers__SWIG_1(swigCPtr, ServiceList.getCPtr(services));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
