...
public class Message : IDisposable {
  ...
  public void setAudioMessage(string templateName, SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_t arguments) {
    netspireSDKPINVOKE.Message_setAudioMessage__SWIG_5(swigCPtr, templateName, SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_t.getCPtr(arguments));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void setAudioMessage(string pathToRecordedStreamToUpload, Message.AudioEncoding encoding) {
    netspireSDKPINVOKE.Message_setAudioMessage__SWIG_6(swigCPtr, pathToRecordedStreamToUpload, (int)encoding);
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
