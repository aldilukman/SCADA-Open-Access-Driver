...
// An instance of a MCX (Rolling Stock Controller)
class DeviceMCX : public Device
{
public:
	DeviceMCX(int elemNo, const std::string &deviceId, int nsType, int dstNo, int portNo, const std::string &deviceModelName);
	~DeviceMCX();
private:
};
...
// An instance of a VCU3 based on x86 (Video Controller Unit)
class DeviceVCU3 : public Device
{
public:
	DeviceVCU3(int elemNo, const std::string &deviceId, int nsType, int dstNo, int portNo, const std::string &deviceModelName);
	~DeviceVCU3();
private:
};

// An instance of a VCU4 based on ARM (Video Controller Unit)
class DeviceVCU4 : public Device
{
public:
	DeviceVCU4(int elemNo, const std::string &deviceId, int nsType, int dstNo, int portNo, const std::string &deviceModelName);
	~DeviceVCU4();
private:
};
