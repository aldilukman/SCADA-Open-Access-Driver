...
namespace termInfo
{
	...
	{
		NS_DUMMY_NONE = 0,
		NS_DEV_CXS = 7,			// Communication Exchange Server
		NS_DEV_TCX = 20,		// Train Communications Exchange
		NS_DEV_TGU = 21,		// Train Gateway Unit
		NS_DEV_CAC = 22,		// Cabin Audio Controller
		NS_DEV_PEI = 23,		// Passenger Emergency Intercom (PUHTC01 PUHTS01)
		NS_DEV_CI = 24,			// Crew Intercom
		NS_DEV_CP = 25,			// Crew Panel
		NS_DEV_NAC = 26,		// Network Audio Controller (NAC)
		NS_DEV_VCU3 = 27,		// Intel based VCU (NUC)
		NS_DEV_IPS = 28,		// IP Paging Station (IPPA)
		NS_DEV_NAM2I = 29,		// Network Amplifier Module (NAM2i NAM2i-loop)
		NS_DEV_NAR4C = 30,		// Network Audio Router (NAR4c)
		NS_DEV_IPHP = 31,		// IP Help Phone (PUAET02/03/04)
		NS_DEV_IPS_LCD = 32,	// IP Paging Station with LCD (IPS_LCD)
		NS_DEV_MCX = 35,		// Rolling Stock Controller (MCX)
		NS_DEV_VCU4 = 36,		// MX200 based VCU (DILL103, DILL109, DILL442)
		NS_DUMMY_IDI = 201,		// Internal Display Indicator controlled by resDCI on server (e.g. BWIN)
		NS_DUMMY_EDI = 202,		// External Display Indicator controlled by resDCI on server (e.g. BWIN)
