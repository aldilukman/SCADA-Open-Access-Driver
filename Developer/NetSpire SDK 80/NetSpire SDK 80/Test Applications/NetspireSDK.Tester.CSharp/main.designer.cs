namespace NetspireSDKTester
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.buttonGetPaZoneMembers = new System.Windows.Forms.Button();
			...
			// paControlTabPage
			// 
			this.paControlTabPage.Controls.Add(this.buttonGetPaZoneMembers);
			...
			// 
			// buttonGetPaZoneMembers
			// 
			resources.ApplyResources(this.buttonGetPaZoneMembers, "buttonGetPaZoneMembers");
			this.buttonGetPaZoneMembers.Name = "buttonGetPaZoneMembers";
			this.buttonGetPaZoneMembers.UseVisualStyleBackColor = true;
			this.buttonGetPaZoneMembers.Click += new System.EventHandler(this.buttonGetPaZoneMembers_Click);
			// 
		...
		private System.Windows.Forms.Button buttonGetPaZoneMembers;
	}
}
