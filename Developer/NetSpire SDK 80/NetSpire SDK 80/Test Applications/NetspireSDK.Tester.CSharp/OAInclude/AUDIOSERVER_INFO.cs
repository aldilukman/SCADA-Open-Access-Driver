...
public class AUDIOSERVER_INFO : IDisposable {
  ...
  public SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_t dynamicConfigurationVars {
    set {
      netspireSDKPINVOKE.AUDIOSERVER_INFO_dynamicConfigurationVars_set(swigCPtr, SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_t.getCPtr(value));
    } 
    get {
