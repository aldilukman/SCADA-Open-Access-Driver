...
public class PaSource : IDisposable {
  ...
  public void attachPaZone(string zoneId, PaSource.AttachMode mode) {
    netspireSDKPINVOKE.PaSource_attachPaZone__SWIG_0(swigCPtr, zoneId, (int)mode);
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void attachPaZone(StringArray zoneIdList, PaSource.AttachMode mode) {
    netspireSDKPINVOKE.PaSource_attachPaZone__SWIG_1(swigCPtr, StringArray.getCPtr(zoneIdList), (int)mode);
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void detachPaZone(string zoneId) {
    netspireSDKPINVOKE.PaSource_detachPaZone__SWIG_0(swigCPtr, zoneId);
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void detachPaZone(StringArray zoneIdList) {
    netspireSDKPINVOKE.PaSource_detachPaZone__SWIG_1(swigCPtr, StringArray.getCPtr(zoneIdList));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
