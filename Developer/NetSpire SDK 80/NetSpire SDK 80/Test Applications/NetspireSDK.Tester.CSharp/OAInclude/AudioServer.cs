...
public class AudioServer : IDisposable {
  ...
  public bool updateCampaign(string _campaignXML, string _updateXML, StringArray _fileList) {
    bool ret = netspireSDKPINVOKE.AudioServer_updateCampaign(swigCPtr, _campaignXML, _updateXML, StringArray.getCPtr(_fileList));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public AudioServer.CampaignUpdateStatus getCampaignUpdateStatus() {
    AudioServer.CampaignUpdateStatus ret = (AudioServer.CampaignUpdateStatus)netspireSDKPINVOKE.AudioServer_getCampaignUpdateStatus(swigCPtr);
    return ret;
  }

  public string getCampaignVersion() {
    string ret = netspireSDKPINVOKE.AudioServer_getCampaignVersion(swigCPtr);
    return ret;
  }

  public KeyValueMap getCampaignConfiguration() {
    KeyValueMap ret = new KeyValueMap(netspireSDKPINVOKE.AudioServer_getCampaignConfiguration(swigCPtr), true);
    return ret;
  }

  public StringArray getCampaignLogs() {
    StringArray ret = new StringArray(netspireSDKPINVOKE.AudioServer_getCampaignLogs(swigCPtr), true);
    return ret;
  }
  ...
  public enum CampaignUpdateStatus {
    CAMPAIGN_UPDATE_NONE = 0,
