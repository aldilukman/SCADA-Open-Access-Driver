...
public class PAControllerObserver : IDisposable {
  ...
  public virtual void onMessageUpdate(AnnouncementRequest req) {
    if (SwigDerivedClassHasMethod("onMessageUpdate", swigMethodTypes13)) netspireSDKPINVOKE.PAControllerObserver_onMessageUpdateSwigExplicitPAControllerObserver(swigCPtr, AnnouncementRequest.getCPtr(req)); else netspireSDKPINVOKE.PAControllerObserver_onMessageUpdate(swigCPtr, AnnouncementRequest.getCPtr(req));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void onMessageDelete(AnnouncementRequest req) {
    if (SwigDerivedClassHasMethod("onMessageDelete", swigMethodTypes14)) netspireSDKPINVOKE.PAControllerObserver_onMessageDeleteSwigExplicitPAControllerObserver(swigCPtr, AnnouncementRequest.getCPtr(req)); else netspireSDKPINVOKE.PAControllerObserver_onMessageDelete(swigCPtr, AnnouncementRequest.getCPtr(req));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectoronMessageUpdate(IntPtr req) {
    onMessageUpdate(new AnnouncementRequest(req, false));
  }

  private void SwigDirectoronMessageDelete(IntPtr req) {
    onMessageDelete(new AnnouncementRequest(req, false));
  }
  ...
  private static Type[] swigMethodTypes13 = new Type[] { typeof(AnnouncementRequest) };
  private static Type[] swigMethodTypes14 = new Type[] { typeof(AnnouncementRequest) };
