...
public class Station : NamedId {
  ...
  public Station(int id, string name, bool isMajor, bool isClosed) : this(netspireSDKPINVOKE.new_Station__SWIG_2(id, name, isMajor, isClosed), true) {
  ...
  public void setIsClosed(bool isClosed) {
    netspireSDKPINVOKE.Station_setIsClosed(swigCPtr, isClosed);
  }

  public bool isClosed() {
    bool ret = netspireSDKPINVOKE.Station_isClosed(swigCPtr);
    return ret;
  }
  ...
  public void setListOfPlatforms(SWIGTYPE_p_std__mapT_int_PlatformInfo_std__lessT_int_t_t platforms) {
    netspireSDKPINVOKE.Station_setListOfPlatforms(swigCPtr, SWIGTYPE_p_std__mapT_int_PlatformInfo_std__lessT_int_t_t.getCPtr(platforms));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public void setPlatform(int platformId, PlatformInfo platform) {
    netspireSDKPINVOKE.Station_setPlatform(swigCPtr, platformId, PlatformInfo.getCPtr(platform));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
