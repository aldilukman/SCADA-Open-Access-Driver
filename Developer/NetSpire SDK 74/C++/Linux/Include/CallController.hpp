...
public:
	...
	*
	*/
	void createDestination(const StringArray& bPartyExtList, const std::string& CLI, const std::string& deviceID) throw (std::invalid_argument);
	...
	*/
	int createCall(const std::string& aPartyCLI, const std::string& bPartyCLI) throw (std::invalid_argument);
	...
	* @throw std::invalid_argument This exception is thrown when an invalid CLI is specified.
	*/
	void answerCallOnTerminal(int callReference, const std::string& bPartyCLI, const std::string& aPartyCLI) throw (std::invalid_argument);
	...
	*/
	void resumeCall(int callReference, const std::string& bPartyCLI) throw (std::invalid_argument);
	...
	* @throw std::invalid_argument This exception is thrown when an invalid CLI is specified.
	*/
	void resumeCallOnTerminal(int callReference, const std::string& bPartyCLI, const std::string& aPartyCLI) throw (std::invalid_argument);
	...
	* @throw std::invalid_argument This exception is thrown when an invalid call reference or CLI is specified.
	*/
	void transferCall(int callReference, const std::string& bPartyCLI) throw (std::invalid_argument);
	...
	* @throw std::invalid_argument This exception is thrown when an invalid call reference or CLI is specified.
	*/
	void holdCall(int callReference, const std::string& bPartyCLI) throw (std::invalid_argument);
	...
	*/
	void terminateCall(int callReference, const std::string& callConnection) throw (std::invalid_argument);
	...
	*/
	void terminateCall(int callReference, int cleardownCauseCode) throw (std::invalid_argument);
