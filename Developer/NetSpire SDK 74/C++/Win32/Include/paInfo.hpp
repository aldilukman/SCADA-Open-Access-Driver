...
public:
	...
	**/
	...
	void setGain(double gain, bool persistent = true, bool delayPersistence = true) throw (std::invalid_argument, std::out_of_range);
	...
	// Exceptions:
	//      std::invalid_argument (IllegalArgumentException in Java): Raised if the PaSource is not one of the supported PaSource types.
	double getGain() throw (std::invalid_argument);
	...
	void attachPaZone(const std::string &zoneId, AttachMode mode) throw (std::out_of_range, std::invalid_argument);
	...
	void detachPaZone(const std::string &zoneId) throw (std::out_of_range, std::invalid_argument);
	...
	void detachAllPaZones() throw (std::invalid_argument);
...
public:
	...
	*/
	enum Type
	{
		...
		NETSPIRE_DCI2,							// LED/LCD display unit controlled by resDCI2
		NETSPIRE_DCI4							// LED/LCD display unit controlled by resDCI4
	};
	...
	**/
	...
	void setGain(Gain gain, bool persistent = true, bool delayPersistence = true) throw (std::invalid_argument, std::out_of_range);
	...
	// Exceptions:
	//      std::invalid_argument (IllegalArgumentException in Java): Raised if the PaSink is not one of the supported PaSink types.
	Gain getGain() throw (std::invalid_argument);
	...
	// Requests PaSink of type NETSPIRE_DCI2 or NETSPIRE_DCI4 to reset/reboot
	// Exceptions: std::invalid_argument (IllegalArgumentException in Java): Raised if the PaSink is not of type NETSPIRE_DCI2 or NETSPIRE_DCI4.
	void reset() throw (std::invalid_argument);
};
