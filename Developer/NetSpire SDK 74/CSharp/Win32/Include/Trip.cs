...
public class Trip : NamedId {
  ...
  public Trip(int id, Trip.Direction direction, Trip.Priority priority) : this(netspireSDKPINVOKE.new_Trip__SWIG_2(id, (int)direction, (int)priority), true) {
  }
  ...
  public void setStops(SWIGTYPE_p_std__vectorT_int_t tripStopIds) {
    netspireSDKPINVOKE.Trip_setStops(swigCPtr, SWIGTYPE_p_std__vectorT_int_t.getCPtr(tripStopIds));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
