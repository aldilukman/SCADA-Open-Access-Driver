...
public class AudioServerObserver : IDisposable {
  ...
  public virtual void onAlarmUpdate(Alarm alarm) {
    if (SwigDerivedClassHasMethod("onAlarmUpdate", swigMethodTypes16)) netspireSDKPINVOKE.AudioServerObserver_onAlarmUpdateSwigExplicitAudioServerObserver(swigCPtr, Alarm.getCPtr(alarm)); else netspireSDKPINVOKE.AudioServerObserver_onAlarmUpdate(swigCPtr, Alarm.getCPtr(alarm));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void onAlarmDelete(Alarm alarm) {
    if (SwigDerivedClassHasMethod("onAlarmDelete", swigMethodTypes17)) netspireSDKPINVOKE.AudioServerObserver_onAlarmDeleteSwigExplicitAudioServerObserver(swigCPtr, Alarm.getCPtr(alarm)); else netspireSDKPINVOKE.AudioServerObserver_onAlarmDelete(swigCPtr, Alarm.getCPtr(alarm));
    if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("onAlarmUpdate", swigMethodTypes16))
      swigDelegate16 = new SwigDelegateAudioServerObserver_16(SwigDirectoronAlarmUpdate);
    if (SwigDerivedClassHasMethod("onAlarmDelete", swigMethodTypes17))
      swigDelegate17 = new SwigDelegateAudioServerObserver_17(SwigDirectoronAlarmDelete);
    netspireSDKPINVOKE.AudioServerObserver_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9, swigDelegate10, swigDelegate11, swigDelegate12, swigDelegate13, swigDelegate14, swigDelegate15, swigDelegate16, swigDelegate17);
  }
  ...
  private void SwigDirectoronAlarmUpdate(IntPtr alarm) {
    onAlarmUpdate(new Alarm(alarm, false));
  }

  private void SwigDirectoronAlarmDelete(IntPtr alarm) {
    onAlarmDelete(new Alarm(alarm, false));
  }
  ...
  public delegate void SwigDelegateAudioServerObserver_16(IntPtr alarm);
  public delegate void SwigDelegateAudioServerObserver_17(IntPtr alarm);
  ...
  private SwigDelegateAudioServerObserver_16 swigDelegate16;
  private SwigDelegateAudioServerObserver_17 swigDelegate17;
  ...
  private static Type[] swigMethodTypes16 = new Type[] { typeof(Alarm) };
  private static Type[] swigMethodTypes17 = new Type[] { typeof(Alarm) };
}
