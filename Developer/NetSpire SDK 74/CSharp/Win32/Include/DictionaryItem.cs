...
public class DictionaryItem : IDisposable {
  ...
  public string fileListStr {
    set {
      netspireSDKPINVOKE.DictionaryItem_fileListStr_set(swigCPtr, value);
      if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      string ret = netspireSDKPINVOKE.DictionaryItem_fileListStr_get(swigCPtr);
      if (netspireSDKPINVOKE.SWIGPendingException.Pending) throw netspireSDKPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }

  public StringArray fileList {
    set {
      netspireSDKPINVOKE.DictionaryItem_fileList_set(swigCPtr, StringArray.getCPtr(value));
    } 
    get {
      IntPtr cPtr = netspireSDKPINVOKE.DictionaryItem_fileList_get(swigCPtr);
  ...
  public StringArray getContentsURI() {
    StringArray ret = new StringArray(netspireSDKPINVOKE.DictionaryItem_getContentsURI(swigCPtr), true);
    return ret;
  }
