...
public:
	...
	void setStops(const std::list<ServiceStop>& stops);
	// Returns the list of stations with their timing information as ServiceStop objects
	std::vector<ServiceStop> getStopsSchedule();

	// Returns the next stop in the service, (or the current stop if the State is < DEPARTED)
	//ServiceStop getNextStop();
...
public:
	...
	Service getCurrentService() throw (std::out_of_range);
	...
	void setServices(std::vector<Service>& serviceList);
	std::string getServicesListAsString() { return this->_servicesListAsString; }
	std::vector<Service> getServices();

	// Vehicle control actions
	void createService(unsigned long tripId, unsigned long startTime);
	void deleteService(int serviceId);
	void clearServices();
	void replaceService(unsigned long tripId, unsigned long startTime);
...
public:
	...
	void setPassers(std::list<ServiceStop> serviceStops);
	void setPassers(std::list<Service> services);
...
public:
	...
	Station(int id, const std::string &name, bool isMajo);
	...
	PlatformInfo getPlatform(int platformId) throw (std::out_of_range);
...
private:
	...
	// List of all the platforms exist whithin this station
...
public:
	...
	*******************************************************************************************/
	...
	void setLocationRetrievalMethod(LocationRetrievalMethod method) {} // TODO

	LocationRetrievalMethod getLocationRetrievalMethod() { return SIGNALLING; } // TODO
	
	// Returns the current status of the automatic message generation system (enabled/disabled)
	...
	// Returns list of all Lines defined in the system
	std::vector<Line> getLines();
	
	void setVehicles(const std::list<Vehicle>& vehicle);
	void addVehicle(const Vehicle& vehicle);
	// Returns list of all Vehicles defined in the system
	std::vector<Vehicle> getVehicles();

	void setStations(const std::list<Station>& stations);
	void addStation(const Station& station);
	// Returns list of all Stations defined in the system
	...
	void setServices(const std::list<Service>& services) {} // TODO
	void addService(const Service& service) {} // TODO
	void deleteService(int serviceId) {} // TODO
	// Returns list of all Services defined in the system
	std::vector<Service> getServices();

	void setServiceStops(const std::list<ServiceStop>& serviceStops) {} // TODO
	void addServiceStop(const ServiceStop& serviceStop) {} // TODO
	void deleteServiceStop(int serviceStopId) {} // TODO
	// Returns list of all ServiceStops defined in the system
	...
	// Helper Functions
	void initPIS();
	void updatePassengerInformation(bool updateIsFromPiStorage, int dstNo, int elemId, int elemNo, DVAlist *elemArgList);
	void deletePassengerInformation(bool deleteIsFromPiStorage, int elemId, int elemNo);

private:
	struct InformationContainer
	{
	...
	bool piStorageIsPresentingSignallingInformation;
	InformationContainer piStorageInformationContainer;

	bool dataManagerIsPresentingSignallingInformation;
	InformationContainer dataManagerInformationContainer;

	// The registered event observer object
	std::vector<PassengerInformationObserver *> _pisObserverList;

	// Helper Functions
	void updateSignallingServerStatus(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateLine(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateVehicle(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateVehicleState(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateStation(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updatePlatform(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updatePlatformState(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateTrip(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateService(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateServiceState(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateTripStop(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
	void updateServiceStop(bool updateIsFromPiStorage, int elemNo, DVAlist *elemArgList);
};
