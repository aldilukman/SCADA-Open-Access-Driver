...
public class PaSink : IDisposable {
  ...
  public SWIGTYPE_p_std__listT_PaSinkAmplifierPortInfo_t amplifierPortList {
    set {
      netspireSDKPINVOKE.PaSink_amplifierPortList_set(swigCPtr, SWIGTYPE_p_std__listT_PaSinkAmplifierPortInfo_t.getCPtr(value));
    } 
    get {
      IntPtr cPtr = netspireSDKPINVOKE.PaSink_amplifierPortList_get(swigCPtr);
      SWIGTYPE_p_std__listT_PaSinkAmplifierPortInfo_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__listT_PaSinkAmplifierPortInfo_t(cPtr, false);
      return ret;
    } 
  }
