...
public class ScheduleDefinition : IDisposable {
  ...
  public KeyValueMap displayTemplateKeyValueList {
    set {
      netspireSDKPINVOKE.ScheduleDefinition_displayTemplateKeyValueList_set(swigCPtr, KeyValueMap.getCPtr(value));
    } 
    get {
